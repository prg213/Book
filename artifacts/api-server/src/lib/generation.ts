...
TITLE TEXT: The book title "${story.title}" must appear at the TOP of the image in small-to-medium, bold, decorative children's book lettering — readable but compact, NOT oversized. CRITICAL LAYOUT RULE: The title text must fit entirely within the CENTRAL 60% of the image width — leave at least 20% empty margin on the LEFT and 20% empty margin on the RIGHT. If the title is long, break it onto 2 lines. The title is horizontally centred within that central band. Keep the font size modest so the title occupies no more than 15% of the image height. This margin rule is essential because the image will be displayed in portrait (A5) format and the outer edges will be cropped. The scene background art fills completely behind and around the title text — the background scene reaches every edge of the canvas.
