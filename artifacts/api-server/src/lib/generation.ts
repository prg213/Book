...
CHARACTER APPEARANCE — reproduce faithfully: ${characterDesc}
${char2Line}
...
/** Page illustration prompt — character MUST appear in every scene */
...
CHARACTER APPEARANCE (keep 100% consistent with cover and all other pages): ${characterDesc}
${char2Line}
...
- Friendly, expressive pose appropriate to the scene
...
Respond ONLY with a JSON object:
{
  "pages": [
    ...
    for (let i = 0; i < pages.length; i++) {
      ...
      try {
        const pagePrompt = buildPagePrompt(story, page, characterDesc, character2Desc);
