...
const OUTFIT_OPTIONS: Record<string, Array<{ emoji: string; label: string; value: string }>> = {
  adventure: [
    ...
    { emoji: '🦺', label: 'Safari Outfit', value: 'khaki safari outfit with utility vest and pith helmet' },
    { emoji: '🧗', label: 'Mountain Climber', value: 'bright mountain climber outfit with harness and climbing helmet' },
  ...
  magic: [
    ...
    { emoji: '🎩', label: 'Magic Apprentice', value: 'magic apprentice uniform with oversized hat and enchanted satchel' },
  ],
  'fairy tale': [
    ...
    { emoji: '🌈', label: 'Enchanted Cloak', value: 'rainbow enchanted cloak that shifts colour with magical boots' },
  ...
  sports: [
    ...
    { emoji: '🏅', label: 'Olympic Tracksuit', value: 'sleek Olympic tracksuit with country flag badge and gold medal' },
    ...
    { emoji: '🤸', label: 'Gymnastics Leotard', value: 'sparkly gymnastics leotard with ribbon accessories and ballet shoes' },
    { emoji: '🏆', label: 'Champion Cape', value: 'champion outfit with trophy-print cape and gold championship belt' },
  ],
  cooking: [
    { emoji: '👨‍🍳', label: "Chef's Hat & Apron", value: "tall white chef's hat and double-breasted chef jacket with apron" },
    ...
    { emoji: '🥄', label: 'Kitchen Assistant', value: 'colourful kitchen assistant outfit with utensil pockets and chef clogs' },
  ...
  dinosaurs: [
    ...
    { emoji: '🏕️', label: 'Prehistoric Explorer', value: 'prehistoric explorer outfit with fossil-finder kit and dino-claw cap' },
    { emoji: '🦖', label: 'Raptor Rider', value: 'raptor rider outfit with protective vest, goggles, and riding boots' },
    { emoji: '🔍', label: 'Fossil Hunter', value: 'fossil hunter outfit with magnifying glass, brush kit, and khaki vest' },
  ...
  'enchanted forest': [
    ...
    { emoji: '🍄', label: 'Mushroom Costume', value: 'whimsical mushroom costume with spotted cap, white tunic, and toadstool bag' },
  ],
  'time travel': [
  ...
  circus: [
    ...
    { emoji: '🎩', label: 'Magician Outfit', value: "magician's tuxedo with top hat, white gloves, and magic wand" },
  ...
  'farm animals': [
    ...
    { emoji: '🌾', label: 'Scarecrow Costume', value: 'fun scarecrow costume with patched clothing, straw hat, and hay details' },
        ...
        <div className="bg-card rounded-3xl shadow-xl border border-card-border p-8">
          ...
          {step === 2 && (
            <div className="space-y-7">
              ...
              {/* Outfit picker — appears once a theme is chosen */}
              {theme && (
                <div>
                  <Label className="text-sm font-semibold">
                    Outfit <span className="font-normal text-muted-foreground">(optional — pick one to match the theme)</span>
                  </Label>
