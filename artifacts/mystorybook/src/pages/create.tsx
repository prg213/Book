...
const TITLE_SUGGESTIONS: Record<string, (name: string) => string[]> = {
  ...
  'little red riding hood': (n) => [`${n} & the Big Bad Wolf`, `${n} Through the Woods`, `${n}'s Red Hood Adventure`],
  goldilocks:               (n) => [`${n} & the Three Bears`, `${n}'s Bear House Visit`, `Just Right for ${n}`],
  cinderella:               (n) => [`${n}'s Magical Ball`, `${n} & the Glass Slipper`, `${n}'s Fairy Godmother`],
  'jack and the beanstalk': (n) => [`${n} & the Beanstalk`, `${n} Climbs to the Clouds`, `${n} & the Giant`],
  'hansel and gretel':      (n) => [`${n} & the Candy Cottage`, `${n} in the Enchanted Woods`, `${n}'s Sweet Escape`],
  'three little pigs':      (n) => [`${n} Builds a House`, `${n} & the Big Bad Wolf`, `${n}'s Strongest House`],
  'sleeping beauty':        (n) => [`${n} & the Sleeping Spell`, `${n} Breaks the Curse`, `Once Upon a ${n}`],
...
const OUTFIT_OPTIONS: Record<string, Array<{ emoji: string; label: string; value: string }>> = {
  ...
  'little red riding hood': [
    { emoji: '🧣', label: 'Red Riding Hood', value: 'iconic red hooded cape over a white pinafore dress with a wicker basket' },
    { emoji: '🌸', label: 'Woodland Dress', value: 'floral woodland dress with red ribbon belt and flower crown' },
    { emoji: '🐺', label: 'Brave Explorer', value: 'red explorer cloak with lantern, map satchel, and sturdy boots' },
    { emoji: '🍎', label: 'Cottage Visitor', value: 'cosy red cape with a patchwork skirt, apron, and picnic basket' },
    { emoji: '🌲', label: 'Forest Guardian', value: 'red hooded ranger cloak with nature badge, compass, and berry pouch' },
    { emoji: '⚔️', label: 'Wolf Tamer', value: 'red adventurer coat with silver wolf-charm necklace and hunting boots' },
  ],
  goldilocks: [
    { emoji: '🐻', label: 'Golden Pinafore', value: 'golden-yellow pinafore dress with white blouse, golden ringlets, and mary-jane shoes' },
    { emoji: '🥣', label: 'Cosy Cottage', value: 'blue gingham dress with white apron, golden curls, and porridge bowl prop' },
    { emoji: '🌻', label: 'Sunny Outfit', value: 'bright sunflower-yellow dress with golden hair ribbons and daisy accessories' },
    { emoji: '🐝', label: 'Forest Wanderer', value: 'honey-coloured peasant dress with braided golden hair and flower basket' },
    { emoji: '👑', label: 'Golden Princess', value: 'glittery gold princess gown with blonde ringlet wig and golden tiara' },
    { emoji: '🎀', label: 'Curls & Bows', value: 'pastel yellow ruffled dress with oversized golden bow and ringlet pigtails' },
  ],
  cinderella: [
    { emoji: '👠', label: 'Ball Gown', value: 'magnificent sky-blue cinderella ball gown with silver glass slippers and pearl tiara' },
    { emoji: '🧹', label: 'Servant Dress', value: 'simple grey work dress with white apron, broom, and small blue hair bow' },
    { emoji: '✨', label: 'Fairy Godmother', value: 'sparkly lavender fairy godmother gown with wand, star crown, and glitter wings' },
    { emoji: '🎃', label: 'Pumpkin Coach', value: 'orange and gold carriage-driver outfit with pumpkin accessories and stars' },
    { emoji: '👑', label: 'Princess Gown', value: 'ice-blue princess ball gown with silver embroidery, tiara, and glass slippers' },
    { emoji: '🌟', label: 'Midnight Magic', value: 'midnight-blue enchanted gown covered in glowing stars with sparkle accessories' },
  ],
  'jack and the beanstalk': [
    { emoji: '🌱', label: 'Village Boy', value: 'classic village boy outfit with felt hat, red neckerchief, brown trousers, and boots' },
    { emoji: '🌿', label: 'Beanstalk Climber', value: 'adventurer outfit with climbing harness, leaf-green jacket, and vine belt' },
    { emoji: '⚔️', label: 'Giant Slayer', value: 'brave hero tunic with leather armour, small sword, and golden harp satchel' },
    { emoji: '☁️', label: 'Cloud Explorer', value: 'sky-blue explorer outfit with cloud-print scarf, goggles, and map pouch' },
    { emoji: '🪄', label: 'Magic Beans', value: 'merchant outfit with coin purse, magic bean pouch, striped waistcoat, and cap' },
    { emoji: '🏰', label: 'Castle Raider', value: 'daring castle raider outfit with hooded cloak, rope lasso, and golden goose bag' },
  ],
  'hansel and gretel': [
    { emoji: '🏠', label: 'Candy House', value: 'gingerbread-coloured outfit with icing-white trim, gumdrop buttons, and sweet accessories' },
    { emoji: '🍬', label: 'Sweet Explorer', value: 'red and white candy-cane striped outfit with peppermint accessories and candy bag' },
    { emoji: '🌲', label: 'Forest Child', value: 'cosy forest outfit with leaf-patterned cloak, pebble pouch, and breadcrumb satchel' },
    { emoji: '🔥', label: 'Witch Escaper', value: 'woodland escape outfit with torn cloak, lantern, and rescue rope' },
    { emoji: '🧁', label: 'Baker Kid', value: "baker's outfit with flour-dusted apron, muffin-tin hat, and rolling pin" },
    { emoji: '🍭', label: 'Sugar Plum', value: 'sugar plum purple outfit with lollipop staff, candy crown, and rainbow accessories' },
  ],
  'three little pigs': [
    { emoji: '🏗️', label: 'Builder Gear', value: 'construction worker overalls with hard hat, tool belt, and blueprints roll' },
    { emoji: '🌾', label: 'Straw Hat', value: 'straw farmer outfit with hay-woven hat, pitchfork, and bundle of straw' },
    { emoji: '🪵', label: 'Wood Cutter', value: 'lumberjack plaid shirt with axe holster, log-carrier straps, and forest boots' },
    { emoji: '🧱', label: 'Master Builder', value: 'master builder outfit with brick-red apron, trowel belt, and stone-pattern gloves' },
    { emoji: '🏠', label: 'Home Keeper', value: 'cosy home outfit with striped shirt, door-key necklace, and welcome-mat satchel' },
    { emoji: '🐺', label: 'Wolf Defender', value: 'brave defender armour with wolf-proof shield, horn trumpet, and fortress badge' },
  ],
  'sleeping beauty': [
    { emoji: '👸', label: 'Aurora Gown', value: 'soft pink or blue princess ball gown with gold crown, rose accessories, and sparkle trim' },
    { emoji: '🌹', label: 'Rose Princess', value: 'rose-pink gown with rosebud crown, petal skirt, and enchanted spindle sceptre' },
    { emoji: '🧚', label: 'Fairy Blessing', value: 'shimmering good-fairy outfit with star wand, gossamer wings, and blessing sparkles' },
    { emoji: '🗡️', label: 'Brave Prince', value: 'royal prince armour with golden sword, shield with rose crest, and flowing cape' },
    { emoji: '🌙', label: 'Dream Weaver', value: 'moonlight-silver gown with dream-catcher accessories, sleeping stars, and veil' },
    { emoji: '🌿', label: 'Enchanted Castle', value: 'enchanted forest outfit with thorny-rose vine accessories and sleeping-curse amulet' },
  ],
  sports: [
                  ...
                  <Select value={theme} onValueChange={(v) => { setTheme(v); setOutfit(''); }}>
                    ...
                    <SelectContent className="max-h-72 overflow-y-auto">
                      {[
                        ...
                        ['jack and the beanstalk','🌱 Jack & the Beanstalk'],
