  ...
  return (
    <div className="w-full flex flex-col gap-2">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 rounded-xl border px-4 py-3 text-sm font-medium transition-colors disabled:opacity-50"
        style={{
          background: '#fff',
      ...
      <div className="flex items-center gap-3 my-1">
        ...
        <span className="text-xs" style={{ color: 'hsl(25,20%,50%)' }}>or</span>
        <div className="flex-1 h-px" style={{ background: 'hsl(28,25%,88%)' }} />
      </div>
    </div>
  );
